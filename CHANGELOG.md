...
## 1.20.0 - 2025-11-24
### Changed
- YLP-572 enhance logs for audit trails

## 1.19.0 - 2025-08-20
### Changed
- YLP-3667 gets a diabetic profile (only update seagull version)

## 1.18.2 - 2025-07-15
### Changed
- YLP-3541 Make Pin-Reset process robust to nil pointer exceptions
...
## 1.18.0 - 2025-05-15
### Changed
- YLP-3572 use the auth service route instead of the legacy shoreline route to get and update user details
...
## 1.17.0 - 2025-02-13
### Added
- YLP-3454 create index in confirmation

## 1.16.1 - 2024-09-18
### Changed
- YLP-3236 update tidev2 client
...
## 1.15.2 - 2013-11-23
### Engineering
- YLP-2703 Bump versions of dependencies
